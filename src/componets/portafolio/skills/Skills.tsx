...
const Skills: React.FC = () => {
    ...
    const skills: Skill[] = [
        ...
        },
        {
            ...
            icon: (
                <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M0 24L12 12 24 24zm0 0V0L12 12zM12 0l12 12L12 12z" />
                </svg>
            ),
    ...
    const categories = [
        {
            title: t("skills.categories.mobile") || "Desarrollo Móvil",
            techs: ["React Native", "Kotlin", "Java"]
        },
        {
            title: t("skills.categories.web") || "Desarrollo Web",
            techs: ["React", "JavaScript", "TypeScript", "HTML", "CSS"]
        }
    ];
