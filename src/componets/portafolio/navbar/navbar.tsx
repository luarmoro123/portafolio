...
const Navbar: React.FC = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 overflow-x-hidden ${scrolled
        ? "bg-black/95 backdrop-blur-lg shadow-xl border-b border-cyan-500/20"
        : "bg-linear-to-b from-black/80 via-[#0a0a0a]/60 to-transparent backdrop-blur-md"
        }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex items-center justify-between h-16">
          ...
          <a
            href="#inicio"
            className="relative group flex items-center gap-2 text-xl sm:text-2xl font-bold focus:outline-none focus:ring-2 focus:ring-cyan-400 rounded-lg px-2 py-1"
          >
            ...
            <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-linear-to-r from-cyan-400 to-blue-500 transition-all duration-300 group-hover:w-full"></div>
          </a>
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <div className="relative">
              ...
              {isLangOpen && (
                <div className="absolute right-0 mt-2 w-40 bg-[#0a0a0a]/95 backdrop-blur-lg border border-cyan-500/20 rounded-lg shadow-2xl overflow-hidden">
                  {languages.map((lang) => (
                    <button
                      key={lang.code}
            ...
            <a
              ...
              className="group relative flex items-center gap-2 px-5 py-2.5 bg-linear-to-r from-cyan-500 to-blue-500 text-black font-semibold rounded-lg overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/50 focus:outline-none focus:ring-2 focus:ring-cyan-400"
            >
              <span className="relative z-10 flex items-center gap-2">
                <Download className="w-4 h-4" />
                {t("nav.cv")}
              </span>
              <div className="absolute inset-0 bg-linear-to-r from-cyan-400 to-blue-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </a>
          </div>
        ...
        <nav className="mx-4 mt-2 bg-[#0a0a0a]/95 backdrop-blur-lg border border-cyan-500/20 rounded-lg shadow-2xl overflow-hidden">
          <div className="px-4 py-3 space-y-1">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setIsOpen(false)}
              className="block mx-4 mb-3 px-4 py-3 bg-linear-to-r from-cyan-500 to-blue-500 text-black text-center font-semibold rounded-lg hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300"
            >
